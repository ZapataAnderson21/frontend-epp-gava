  ...
  return (
    <div className={`${isOpen ? "absolute" : "hidden"} bottom-4 right-4`}>
      <div className="relative flex w-36">
        <div className="absolute bg-[#eaa630] rounded-xl top-[-64px] left-[-260px] text-white text-[14px] p-2 flex items-center"> 
          <span className="flex flex-row items-start px-3 py-2 justify-center w-68 z-10">
            Recuerda que si el requerimiento es para mañana, la hora límite para registrarlo es hasta la 1:00 PM. 
          </span>
          <IoTriangleSharp className=" absolute text-[#eaa630] size-24 bottom-[-30px] rotate-25 right-0" />
        </div>
