          ...
          <div>
            <div className="flex flex-row items-center justify-center gap-4">
              <div className="hidden sm:flex flex-col items-end justify-center">
                <span className="text-gray-700 font-bold text-nowrap">HENRY GAYOSO</span>
                <span className="text-gray-800 text-sm font-extrabold">GERENTE</span>
              </div>
              <div className="flex items-center justify-center border border-gray-300 rounded-full w-14">
