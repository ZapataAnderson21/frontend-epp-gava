import { Calendar as FaRegCalendar } from "lucide-react";
...
export default function ReturnButton({ disabled }: ReturnButtonProps) {
  ...
  const handleClickDay = (date: Date) => {
    ...
    navigate(`/admin/projects/${projectId}/payrolls/attendances?date=${year}-${month}-${day}`);
  };
        ...
        visible && (
          <div className="absolute z-10 mt-2 top-10 right-0">
            <Calendar
              ...
              className="border-0 rounded-md text-xs text-gray-700 p-2 shadow-lg"
