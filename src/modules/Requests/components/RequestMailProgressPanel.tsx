        ...
        <ul className="flex flex-col gap-3">
          {events.map((event, index) => (
            ...
            >
              ...
              <span className="text-xs text-gray-800">{event.message}</span>
              <span className="rounded-full bg-gray-100 px-2 py-0.5 text-2xs font-semibold text-gray-600">
